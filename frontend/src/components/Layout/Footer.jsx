...
const Footer = () => {
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div
            className="flex items-center justify-center lg:justify-between flex-col lg:flex-row  gap-7 lg:gap-0 border-b border-gray-200">
            <NavLink to="/" className="flex justify-center lg:justify-start">
                <img src={logo} className='h-28'/>
            </NavLink>
            <NavLink to="#"
                className="flex items-center gap-2 py-3.5 px-7 rounded-full bg-gray-900 shadow-md text-white font-semibold hover:bg-gray-800">Sign Up <svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div
                ...
                <div className="block">
                    ...
                    <ul className="grid gap-4 min-[500px]:gap-6 text-center min-[500px]:text-left">
                        <li><NavLink to="/" className="text-gray-600 hover:text-gray-900">Home</NavLink></li>
                        <li><NavLink to="/about" className="text-gray-600 hover:text-gray-900">About </NavLink></li>
                        <li><NavLink to="/contact" className="text-gray-600 hover:text-gray-900">Contact </NavLink></li>
                ...
                <div className="block">
                    <h4
                        ...
                        Categories</h4>
                    <ul className="grid gap-4 min-[500px]:gap-6 text-center min-[500px]:text-left">
                        <li><NavLink to="#" className="text-gray-600 hover:text-gray-900">Everything</NavLink>
                        </li>
                        <li><NavLink to="#" className="text-gray-600 hover:text-gray-900">Clothes</NavLink></li>
                        <li><NavLink to="#" className="text-gray-600 hover:text-gray-900">Bags</NavLink>
                        </li>
                        <li><NavLink to="#" className="text-gray-600 hover:text-gray-900">Accessories</NavLink>
                        </li>
                    </ul>
                </div>
                <div className="block">
                    <h4
                        ...
                        Policies</h4>
                    <ul className="grid gap-4 min-[500px]:gap-6 text-center min-[500px]:text-left">
                        <li><NavLink to="#" className="text-gray-600 hover:text-gray-900">Terms & Conditions</NavLink></li>
                        <li><NavLink to="#" className="text-gray-600 hover:text-gray-900">Payments & Orders</NavLink></li>
                        <li><NavLink to="#" className="text-gray-600 hover:text-gray-900">Shipping & Returns</NavLink></li>
                        <li><NavLink to="#" className="text-gray-600 hover:text-gray-900">Privacy Policy</NavLink></li>
                    </ul>
                </div>
            </div>
        ...
        <div className="py-9 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
                <span className="text-sm text-gray-500 ">©<NavLink to="https://pagedone.io/">VogueVibe</NavLink> 2024, All rights reserved.</span>
